...
4. ЗАВЖДИ створюй draft, якщо є хоча б: якесь ім'я контрагента (навіть часткове, одне слово) + хоча б 1 товар + кількість + ціну. НЕ ПИТАЙ уточнення, якщо користувач вже назвав контрагента — навіть скорочено чи одним словом. Система сама знайде повну назву в каталозі.
...
8. Якщо контрагент вказаний частково (напр. "зелень", "магазин Олени") — все одно створюй draft із тим що є. Система автоматично знайде точну назву або запропонує варіанти.
